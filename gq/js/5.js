    ...
    d3.queue()
       ...
       // console.log(d)
        ...
        var x = d3.scaleLinear()
                        .range([0, width - 200])
                        .domain([d3.min(data_1, function (d) { return d.name - 10; }), d3.max(data_1, function (d) { return d.name + 10; })])
                        .nice();

        var y = d3.scaleLinear()
            .range([height, 0])
            .domain([d3.max(data_2, function (d) { return d.name - 10; }), d3.max(data_2, function (d) { return d.name + 10; })])
            .nice();
     ...
     console.log(data1)
        ...
        svg_map.append("g")
            ...
            .attr("fill", function(d) {
                ...
                d.total = data1.get(d.properties.name) || 0;
