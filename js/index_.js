  ...
  playButton
    ...
    function mousemoveLegend(d, index) {
      // console.log(d)
        ...
        Tooltip
            .html("Country: " + d["name"] +
                "<br> "+rValue+": " + (data_r.get(d["name"])).toFixed(4) +
                "<br> "+yValue+": " + (data_y.get(d["name"]) ).toFixed(4)+
    ...
    function mousemoveLegend2(d, index) {
      ...
      if (data_r.get(i) != undefined){
        Tooltip
            .html("Country: " + i +
                "<br> "+rValue+": " + (data_r.get(i)).toFixed(4) +
                "<br> "+yValue+": " + (data_y.get(i)).toFixed(4) +
                "<br> "+xValue+": " + (data_x.get(i)).toFixed(4)
